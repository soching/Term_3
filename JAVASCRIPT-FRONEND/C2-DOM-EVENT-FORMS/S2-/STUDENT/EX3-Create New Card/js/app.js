...
function createCard() {
 ...
 cardImage.src="images/sample.png";
  ...
  const text = document.createTextNode("Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem, atque.");
  ...
  const text1 = document.createTextNode('remove card');
  cardButton.appendChild(text1);
